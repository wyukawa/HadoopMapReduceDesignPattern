...
public class PairsTest {
	...
	public void testRun() throws Exception {
		...
		Path input = new Path(System.getProperty("user.dir")
				+ "/src/test/resources/ch03/Pairs/input");
	...
	private void checkOutput(JobConf conf, Path output) throws IOException {
		...
		BufferedReader expected = asBufferedReader(Thread.currentThread().getContextClassLoader().getResourceAsStream("ch03/Pairs/expected.txt"));
		String expectedLine;
